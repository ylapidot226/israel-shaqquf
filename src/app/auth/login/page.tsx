    ...
    <div className="flex min-h-[calc(100vh-10rem)] items-center justify-center px-4">
      <div className="w-full max-w-sm">
        <div className="mb-6 text-center">
          ...
          <h1 className="text-xl font-bold text-[var(--foreground)]">כניסה לחשבון</h1>
          <p className="mt-1 text-sm text-[var(--muted)]">ישראל שקופה</p>
        </div>

        <div className="rounded-xl border border-[var(--card-border)] bg-[var(--card)] p-6">
          <button
            onClick={handleGoogle}
            className="mb-4 flex w-full items-center justify-center gap-3 rounded-lg border border-[var(--card-border)] bg-[var(--background)] px-4 py-2.5 text-sm font-medium hover:bg-[var(--card)] transition-colors"
          >
          ...
          <div className="relative mb-4">
            ...
            <div className="relative flex justify-center text-xs text-[var(--muted)]">
              <span className="bg-[var(--card)] px-2">או</span>
            </div>
          </div>
